            ...
            <div className="hidden sm:ml-6 sm:flex">
              {pages.map((page) => (
                <button
                  ...
                  className="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-600 hover:text-gray-800 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:border-gray-300 transition duration-150 ease-in-out"
                  key={page.slug}
                >
                  {page.title}
                </button>
